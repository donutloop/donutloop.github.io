...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function eh(){return new Se({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Il(),fragmentShader:`
		...
		`,blending:hn,depthTest:!1,depthWrite:!1})}function nh(){return new Se({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Il(),fragmentShader:`
